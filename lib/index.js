...
let AutoCache = function (opts) {
    ...
    this.redlock       = this.store.redlock;
    this.i             = 0;
};
...
AutoCache.prototype.pub = function (channel, field, data) {
    return this.store.pub(channel, field, data);
};

AutoCache.prototype.sub = function (channel, field) {
    return this.store.sub(channel, field);
};
